...
export default function Careers() {
  ...
  const jobListings: JobListing[] = [
    {
      ...
      description:
        "Join our engineering team to build the future of sustainable mobility in India. Work on cutting-edge EV technology and help scale our platform to millions of users.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Drive user acquisition and engagement strategies for KWICK. Lead digital marketing campaigns and help us reach every corner of India.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Oversee the day-to-day operations of our EV fleet. Ensure optimal vehicle utilization, maintenance scheduling, and customer satisfaction.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Create beautiful and intuitive user experiences for our mobile and web applications. Help design the future of sustainable mobility.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Be the voice of our customers and ensure they have the best possible experience with KWICK. Help solve problems and drive customer satisfaction.",
      requirements: [
    ...
    },
    {
      ...
      description:
        "Use data to drive business decisions and optimize our platform. Build predictive models and extract insights from our growing dataset.",
      requirements: [
  ...
  const departments = [
    { id: "all", name: "All Departments", count: jobListings.length },
    {
      id: "Engineering",
      name: "Engineering",
      count: jobListings.filter((j) => j.department === "Engineering").length,
    },
    {
      id: "Marketing",
      name: "Marketing",
      count: jobListings.filter((j) => j.department === "Marketing").length,
    },
    {
      id: "Operations",
      name: "Operations",
      count: jobListings.filter((j) => j.department === "Operations").length,
    },
    {
      id: "Design",
      name: "Design",
      count: jobListings.filter((j) => j.department === "Design").length,
    },
    {
      id: "Customer Success",
      name: "Customer Success",
      count: jobListings.filter((j) => j.department === "Customer Success")
        .length,
    },
    {
      id: "Data & Analytics",
      name: "Data & Analytics",
      count: jobListings.filter((j) => j.department === "Data & Analytics")
        .length,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-red-100 max-w-3xl mx-auto">
              Help us build the future of sustainable mobility in India. Join a
              team that's making a real impact.
            </p>
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              We're not just building a company, we're building the future of
              transportation
            </p>
          </div>
        ...
        <section className="mb-16 bg-white rounded-2xl p-8 lg:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {perks.map((perk, index) => (
              <div
                key={index}
                className="flex items-center space-x-3 p-4 rounded-lg hover:bg-gray-50 transition-colors animate-slide-in-left"
