...
export default function About() {
  const ecoFacts = [
    ...
    },
    {
      ...
      description: "Electric scooters produce 85% fewer emissions than petrol scooters"
    },
    {
      icon: Recycle,
      title: "100% Battery Recycling",
      description: "All our batteries are recycled through certified eco-friendly processes"
    },
    {
      icon: Sun,
      title: "Solar Powered Stations",
      description: "Our battery swap stations run on 60% renewable solar energy"
    }
  ];
  ...
  const successStories = [
    {
      ...
      story: "Switched from petrol bike to KWICK. Now earning ₹5,000 more monthly with zero fuel costs!",
    ...
    },
    {
      ...
      story: "KWICK's unlimited battery swaps means I never stop working. Earning lakhs annually!",
    ...
    },
    {
      ...
      story: "Best decision ever! No maintenance headaches, just pure earning potential.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-red-100 max-w-3xl mx-auto">
              Rent our premium electric scooters and earn ₹15,000 - ₹50,000 monthly through delivery services. 
              Zero fuel costs, unlimited battery swaps, and 100% eco-friendly rides!
            </p>
            ...
            <div className="text-sm text-red-200">
              🏢 Noida Sector 112 Office | 🔋 50+ Battery Swap Stations | 🌱 100% Eco-Friendly
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Born in 2024 as a 2-month-old startup, KWICK emerged from a simple vision: 
                make electric mobility profitable for everyone. We're not just another rental company—
                we're your earning partner in the gig economy revolution.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                With our flagship KWICK EV Scooter, unlimited battery swap network, and 
                AI-powered optimization, riders are earning lakhs annually while building 
                a sustainable future for India.
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-500" />
                  <span className="text-lg">One premium electric scooter model</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-500" />
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-500" />
                  <span className="text-lg">AI-powered earning optimization</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-6 w-6 text-green-500" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {deliveryEarnings.map((earning, index) => (
              <Card key={index} className="text-center border-primary/20 hover:shadow-xl transition-all hover:scale-105">
                <CardHeader>
                  <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <earning.icon className="h-8 w-8 text-primary" />
                  </div>
                  <CardTitle className="text-lg">{earning.title}</CardTitle>
                  <div className="text-2xl font-bold text-green-600">{earning.earnings}</div>
                </CardHeader>
                <CardContent>
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg">
            <h3 className="text-2xl font-bold text-center mb-8">Real Success Stories</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {successStories.map((story, index) => (
                <div key={index} className="text-center">
                  ...
                  />
                  <h4 className="font-semibold text-lg">{story.name}, {story.age}</h4>
                  <p className="text-primary text-sm mb-2">{story.occupation}</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            <h3 className="text-2xl font-bold text-center mb-8">Complete Cost Comparison</h3>
            <div className="overflow-x-auto">
              <table className="w-full bg-white shadow-lg rounded-lg overflow-hidden">
                <thead className="bg-primary text-white">
                  <tr>
                    <th className="px-6 py-4 text-left text-sm font-semibold">Aspect</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold">Buying Scooter</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold">KWICK Rental</th>
                    <th className="px-6 py-4 text-left text-sm font-semibold">Your Savings</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  {comparisonData.map((item, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-red-600">{item.buying}</td>
                      <td className="px-6 py-4 text-sm text-green-600">{item.kwick}</td>
                      <td className="px-6 py-4 text-sm font-semibold text-green-700 bg-green-50">{item.savings}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="text-center mt-8">
              <div className="bg-green-100 p-6 rounded-lg inline-block">
                ...
                <p className="text-green-700">
                  Plus earning potential of ₹5,00,000+ through delivery services!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
              ...
              <p className="text-gray-600">
                For every 1000 km you ride with KWICK, we plant 5 trees and offset 50kg of CO2 emissions. 
                Together, we're not just earning money—we're earning a better planet for our children.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">Instant Battery Swaps</h3>
                    <p className="text-gray-600">Swap your battery in under 30 seconds at any of our stations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">Smart Location Finder</h3>
                    <p className="text-gray-600">AI-powered app shows nearest available swap stations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">Always Charged</h3>
                    <p className="text-gray-600">100% charged batteries ready 24/7 at all locations</p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-primary/20">
              ...
              <CardContent>
                <p className="text-gray-600">
                  AI suggests best delivery routes, peak hours, and high-demand areas to maximize your income
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Predictive alerts for battery swaps and optimal station routing to minimize downtime
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Detailed insights on earnings, efficiency, and personalized tips to increase daily income
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Come meet our team, test ride our KWICK scooters, and learn about earning opportunities in person.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Sector 112, Noida, Uttar Pradesh 201301</p>
                  </div>
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-red-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 text-red-100">
            Join hundreds of riders already earning lakhs with KWICK. 
            Your electric, profitable, eco-friendly future starts today!
          </p>
          ...
          <div className="mt-8 text-sm text-red-200">
            💚 Join the eco-revolution • 💰 Earn lakhs monthly • 🚀 AI-powered success
          </div>
        </div>
      </section>
    </div>
