...
export default function Blog() {
  ...
  const blogPosts: BlogPost[] = [
    {
      id: "1",
      title:
        "How KWICK Riders Are Earning ₹50,000+ Monthly Through Smart Delivery Strategies",
      excerpt:
        "Discover the proven strategies our top riders use to maximize their earnings with KWICK electric scooters.",
    ...
    },
    {
      ...
      excerpt:
        "Learn about the massive environmental benefits of choosing electric vehicles and how you contribute to a cleaner India.",
      content: "Full blog content here...",
    ...
    },
    {
      ...
      excerpt:
        "Explore how our innovative battery swap technology eliminates range anxiety and keeps you moving.",
      content: "Full blog content here...",
      author: "Amit Singh",
    ...
    },
    {
      ...
      excerpt:
        "Read inspiring stories of riders who transformed their lives with KWICK and now earn lakhs annually.",
      content: "Full blog content here...",
      author: "Neha Gupta",
    ...
    },
    {
      ...
      excerpt:
        "Step-by-step guide to complete your KYC verification and start your KWICK journey in under 24 hours.",
      content: "Full blog content here...",
    ...
    },
    {
      ...
      excerpt:
        "Detailed financial analysis showing why renting with KWICK is 60% more cost-effective than buying.",
      content: "Full blog content here...",
  ...
  const categories = [
    { id: "all", name: "All Posts", count: blogPosts.length },
    {
      id: "earnings",
      name: "Earnings & Tips",
      count: blogPosts.filter((p) => p.category === "earnings").length,
    },
    {
      id: "environment",
      name: "Environment",
      count: blogPosts.filter((p) => p.category === "environment").length,
    },
    {
      id: "technology",
      name: "Technology",
    ...
    },
    {
      ...
      count: blogPosts.filter((p) => p.category === "success-stories").length,
    },
    {
      id: "guide",
      name: "Guides",
    ...
    },
    {
      id: "finance",
      name: "Finance",
      count: blogPosts.filter((p) => p.category === "finance").length,
    },
  ];
      ...
      <section className="bg-gradient-to-r from-primary via-red-600 to-red-700 text-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">KWICK Blog</h1>
            <p className="text-xl mb-8 text-red-100 max-w-3xl mx-auto">
              Insights, tips, and success stories from India's leading EV rental
              community
            </p>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {featuredPosts.map((post, index) => (
              <Card
                key={post.id}
                className={`card-hover animate-fade-in ${index === 0 ? "lg:col-span-2 lg:row-span-2" : ""}`}
              ...
              >
                ...
                <CardContent className="p-6">
                  <h3
                    className={`font-bold mb-3 hover:text-primary cursor-pointer transition-colors ${index === 0 ? "text-xl lg:text-2xl" : "text-lg"}`}
                  >
                    {post.title}
                  </h3>
                ...
                {categories.map((category) => (
                  ...
                  >
                    <span className="flex items-center">
                      ...
                      <span className={category.id !== "all" ? "ml-2" : ""}>
                        {category.name}
                      </span>
                    </span>
