...
export default function Pricing() {
  ...
  const comparisonFeatures = [
    { name: "KWICK EV Scooter Access", daily: true, weekly: true, monthly: true },
    { name: "Unlimited Battery Swaps", daily: true, weekly: true, monthly: true },
    { name: "Full Insurance Coverage", daily: true, weekly: true, monthly: true },
    ...
    { name: "Performance Analytics", daily: false, weekly: true, monthly: true },
    { name: "AI Earning Optimization", daily: false, weekly: false, monthly: true },
    { name: "Dedicated Account Manager", daily: false, weekly: false, monthly: true },
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-red-100 max-w-3xl mx-auto">
              ...
              All plans include unlimited battery swaps, full insurance, and 24/7 support.
            </p>
            <div className="text-sm text-red-200">
              📍 Noida Sector 112 • 🔋 50+ Battery Stations • 💰 Earn up to ₹50,000/month
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            >
              {plan.badge && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <Badge className={`${
                    plan.badge === 'Most Popular' ? 'bg-primary' : 'bg-green-600'
              ...
              <CardHeader className="text-center pt-8">
                <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 ${
                  plan.badge === 'Most Popular' ? 'bg-primary/10' : 
                  plan.badge === 'Best Value' ? 'bg-green-100' : 'bg-gray-100'
                }`}>
                  <plan.icon className={`h-8 w-8 ${
                    plan.badge === 'Most Popular' ? 'text-primary' : 
                    plan.badge === 'Best Value' ? 'text-green-600' : 'text-gray-600'
                  }`} />
                </div>
                ...
                <div className="bg-green-50 p-3 rounded-lg mb-6">
                  <p className="text-sm text-green-700 font-semibold">Earning Potential</p>
                  <p className="text-lg font-bold text-green-800">{plan.earningPotential}</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  ...
                  <th className="text-center py-4 px-6 text-gray-900 font-semibold">Daily</th>
                  <th className="text-center py-4 px-6 text-primary font-semibold">Weekly</th>
                  <th className="text-center py-4 px-6 text-green-600 font-semibold">Monthly</th>
                </tr>
              </thead>
              <tbody>
              ...
              <Card key={index} className="border-primary/20">
                ...
                <CardContent className="space-y-3">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold">{service.hoursPerDay} hrs</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Orders/hour:</span>
                    <span className="font-semibold">{service.ordersPerHour}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Avg order value:</span>
                    <span className="font-semibold">₹{service.avgOrderValue}</span>
                  </div>
                  <div className="flex justify-between text-sm border-t pt-3">
                    <span className="text-gray-600">Daily earnings:</span>
                    <span className="font-bold text-green-600">₹{service.dailyEarning}</span>
                  </div>
                  
                  <div className="mt-4">
                    <p className="text-xs text-gray-600 mb-2">Popular partners:</p>
          ...
          <div className="text-center mt-8">
            <div className="bg-green-50 p-6 rounded-lg inline-block">
              ...
              <p className="text-green-700">
                Top riders earn ₹50,000+ monthly by working with multiple platforms
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-8 mb-20">
          <h2 className="text-2xl font-bold text-center mb-8">Why Choose KWICK?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Never worry about charging. 50+ swap stations across NCR.</p>
            </div>
            
            <div className="text-center">
              <Shield className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="font-semibold mb-2">Complete Insurance</h3>
              <p className="text-sm text-gray-600">Full coverage for vehicle, rider, and third-party damages.</p>
            </div>
            
            <div className="text-center">
              <Phone className="h-12 w-12 text-blue-600 mx-auto mb-4" />
              <h3 className="font-semibold mb-2">24/7 Support</h3>
              <p className="text-sm text-gray-600">Round-the-clock assistance for any issues or emergencies.</p>
            </div>
            
            <div className="text-center">
              <Target className="h-12 w-12 text-purple-600 mx-auto mb-4" />
              <h3 className="font-semibold mb-2">AI Optimization</h3>
              <p className="text-sm text-gray-600">Smart algorithms to maximize your daily earnings.</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Complete KWICK EV scooter, unlimited battery swaps, full insurance, 
                  maintenance, roadside assistance, and 24/7 customer support.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Simply visit any of our 50+ swap stations, exchange your depleted 
                  battery for a fully charged one in under 30 seconds. It's free and unlimited.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Yes, you can cancel with 24 hours notice. Monthly plans require 
                  7 days notice. No hidden cancellation charges.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Our top riders earn ₹50,000+ monthly. Average earnings range from 
                  ₹18,000-₹35,000 depending on hours worked and delivery platforms used.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Valid driving license, Aadhaar card, address proof, and one emergency 
                  contact. KYC verification takes 2-4 hours.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Small refundable security deposit based on your plan. 
                  Daily: ₹2,000, Weekly: ₹5,000, Monthly: ₹10,000.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gradient-to-r from-primary to-red-600 text-white py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 text-red-100">
            Join hundreds of riders already earning with KWICK. 
            Your profitable, eco-friendly future starts today!
          </p>
